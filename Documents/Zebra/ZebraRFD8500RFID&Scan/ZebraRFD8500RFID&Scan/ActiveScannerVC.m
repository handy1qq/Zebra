...
- (void)setScannerID:(int)scannerID
{
    ...
    /* Hide unsupported Image&Video tab for CS4070 and RFD8500 */
    if ([scanner_info getScannerModel] == SBT_DEVMODEL_SSI_CS4070 || [scanner_info getScannerModel] == SBT_DEVMODEL_SSI_RFD8500)
    {
