...
zt_ScannerAppEngine *_gsharedAppEngine = nil;

+ (zt_ScannerAppEngine *) sharedAppEngine
{
    @synchronized([zt_ScannerAppEngine class])
    {
        if (_gsharedAppEngine == nil)
        {
            [[self alloc] init];
        }
        
        return _gsharedAppEngine;
    }
...
+(id)alloc
{
    @synchronized([zt_ScannerAppEngine class])
    {
        NSAssert(_gsharedAppEngine == nil, @"Attempted to allocate a second instance of a singleton.");
        _gsharedAppEngine = [super alloc];
        return _gsharedAppEngine;
    }
...
- (void)initializeDcsSdkWithAppSettings
{
    ...
    */
    ...
    if (op_mode == 0)
    {
        ...
        /***
         Changed the default opmode all to MFI
         */
